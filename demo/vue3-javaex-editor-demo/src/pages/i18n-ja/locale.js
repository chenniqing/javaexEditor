export const japaneseLocale = {
  ...
  tableContext: {
    ...
    paste: "貼り付け",
    table: "表",
    rowHeader: "行ヘッダー（1 行目の背景色）",
    colHeader: "列ヘッダー（1 列目の背景色）",
    rowHeaderBold: "行ヘッダーを太字",
    colHeaderBold: "列ヘッダーを太字",
    rowAbove: "上に行を挿入",
    rowBelow: "下に行を挿入",
    rowRemove: "この行を削除",
    colLeft: "左に列を挿入",
  ...
  aiActions: {
    polish: "ワンクリック校正",
    polishDescription: "文章を整え、HTML レイアウトを改善します",
    chat: "AI チャット",
    chatDescription: "選択範囲を対象に小さな修正を依頼します",
    extensionDescription: "拡張アクションを実行"
  },
  tips: {
    ...
    cellPasted: "セルの内容を貼り付けました",
    pasteDenied: "このブラウザーでは直接貼り付けできません",
    cellCut: "セルの内容を切り取りました",
    cellCopied: "セルの内容をコピーしました",
