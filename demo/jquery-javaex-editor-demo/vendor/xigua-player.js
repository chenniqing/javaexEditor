...
const XIGUA_PLAYER_SCRIPT = 'https://unpkg.byted-static.com/xgplayer/2.31.2/browser/index.js';
...
function ensureXiguaPlayerStyle() {
...
function buildXiguaPlayerHtml(options = {}) {
    const {
        id,
        url = '',
        poster = '',
...
function createXiguaPlayerExtension(options = {}) {
    const {
        key = 'xigua-player',
        label = '西瓜播放器',
...
function loadXiguaPlayerScript(src = XIGUA_PLAYER_SCRIPT) {
...
async function decorateXiguaPlayers(container, options = {}) {
...
window.createXiguaPlayerExtension = createXiguaPlayerExtension;
window.decorateXiguaPlayers = decorateXiguaPlayers;
